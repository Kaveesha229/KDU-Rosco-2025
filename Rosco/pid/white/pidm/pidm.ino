...
void wall_pid(uint8_t minSpeed, uint8_t baseSpeed, uint8_t maxSpeed, float Kwp, float Kwi, float Kwd) {  //wall follow
  ...
  if (distance_to_left == 0 || distance_to_left > 100) distance_to_left = 100;
  if (distance_to_right == 0 || distance_to_right > 100) distance_to_right = 100;
